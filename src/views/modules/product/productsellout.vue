  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button
          v-if="isAuth('product:productsellout:save')"
          type="primary"
          @click="addOrUpdateHandle()"
        >新增</el-button>
        <el-button
          v-if="isAuth('product:productsellout:delete')"
          type="danger"
          @click="deleteHandle()"
    ...
    >
      ...
      <el-table-column prop="outNumber" header-align="center" align="center" label="出库数量"></el-table-column>
